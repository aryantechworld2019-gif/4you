  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-orange-50/30 px-4">
      <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 border border-orange-100">
        ...
        <h2 className="text-2xl font-bold text-center text-gray-800 mb-2">4You Broadband Portal</h2>
...
const EngineerDashboard = ({ showNotification, onNewCustomerAdded }) => {
...
const EngineerTasks = ({ showNotification, tasks, onTasksUpdate }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <p className="text-gray-600">This list shows all new customers added. Tap to update the installation status.</p>
